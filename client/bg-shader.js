/**
 * Raw WebGPU procedural background shader (no TypeGPU dependency)
 */
async function initBackground() {
    console.log('[BG-Shader]: Starting Raw WebGPU background...');
    const canvas = document.getElementById('gpu-bg');
    if (!canvas) return;
    
    if (!navigator.gpu) {
        console.warn('WebGPU not supported (bg disabled).');
        return;
    }
